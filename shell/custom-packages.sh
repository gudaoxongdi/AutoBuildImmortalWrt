...
# 代理相关
#CUSTOM_PACKAGES#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n
...
# VPN
#CUSTOM_PACKAGES#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-tailscale luci-i18n-
# 分区扩容 by sirpdboy 
...
# MosDNS
#CUSTOM_PACKAGES#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-mosdns luci-i1
# Turbo ACC 网络加速
...
# Lucky大吉 
#CUSTOM_PACKAGES#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-
# 集客AC
#CUSTOM_PACKAGES#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-ge
# 任务设置
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-taskplan luci-i18n-taskplan-zh-cn"
# Easytier
#@CUSTOM_PACKAGES="$CUSTOM_PACKAGES easytier luci-app-easytier"
# 统一文件共享
#CUSTOM_PACKAGES#CUSTOM_PACKAGES="$CUSTOM_PACKAGES webdav2 lu
